layui.define(['table', 'laypage','jquery', 'element'], function(exports) {
	...
	var gsadminCard = function(opt) {
		this.option = opt;
	};

	gsadminCard.prototype.render = function(opt) {
		var option = {
			// 构建的模型
			elem: opt.elem,
			// 数据 url 连接
		...
		return new gsadminCard(option);
	}

	function createComponent(data) {
        var html = "<div class='gsadmin-card-component'>"
	...
	exports(MOD_NAME, new gsadminCard());
})
