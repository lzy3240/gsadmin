...
(function () {
    ...
    var hasApgsadminanceOptions = function (editor) {
      return editor.getParam('table_apgsadminance_options', true, 'boolean');
    };
    ...
    var getItems$2 = function (editor, classes, insertNewTable) {
      ...
      var apgsadminanceItems = hasApgsadminanceOptions(editor) ? [
        {
          type: 'input',
          name: 'cellspacing',
          label: 'Cell spacing',
      ...
      return rowColCountItems.concat(alwaysItems).concat(apgsadminanceItems).concat(alignmentItem).concat(classListItem);
    };
