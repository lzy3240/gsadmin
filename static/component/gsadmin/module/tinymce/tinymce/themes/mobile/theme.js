...
(function () {
    ...
    var setup = function (realm, editor) {
      ...
      var styleselect = function () {
        return forToolbar('style-formats', function (button) {
          ...
          realm.dropup.apgsadmin(styleFormatsMenu, Toggling.on, button);
        }, derive$1([
          Toggling.config({
            toggleClass: resolve('toolbar-button-selected'),
            toggleOnExecute: false,
    ...
    var build$2 = function (refresh, scrollIntoView) {
      ...
      var apgsadmin = function (menu, update, component) {
      ...
      var disapgsadmin = function (onReadyToShrink) {
        window.requestAnimationFrame(function () {
          onReadyToShrink();
      ...
      var renderUI = function () {
        ...
        editor.on('init', function () {
          ...
          var hideDropup = function () {
            realm.dropup.disapgsadmin(function () {
